...
import { DEMO_USERS, DOCTORS } from '@/lib/mock-data';
import { UserCheck, Plus, Shield, Briefcase, Mail, Phone } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 pb-12">
      <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button className="px-4 py-2 text-xs font-semibold bg-cyan-600 hover:bg-cyan-700 text-white rounded-xl transition-colors shadow-md shadow-cyan-900/20 flex items-center gap-1.5 self-start sm:self-center">
