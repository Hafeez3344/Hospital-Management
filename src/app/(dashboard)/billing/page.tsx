...
import { Receipt, Plus, DollarSign, CreditCard, FileText } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 pb-12">
      <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button className="px-4 py-2 text-xs font-semibold bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl transition-colors shadow-md shadow-indigo-900/20 flex items-center gap-1.5 self-start sm:self-center">
