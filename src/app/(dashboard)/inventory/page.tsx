    ...
    <>
      <div className="space-y-6 pb-12">
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm flex items-center justify-between">
          ...
          <button onClick={() => setOpen(true)} className="px-4 py-2 text-xs bg-amber-600 hover:bg-amber-700 text-white rounded-xl shadow-md flex items-center gap-1.5">
      ...
      <QuickActionModal isOpen={open} onClose={() => setOpen(false)} type="new-stock-item" />
    </>
  );
}
