  ...
  return (
    <div className="space-y-6 pb-12">
      <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button className="px-4 py-2 text-xs font-semibold bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl transition-colors shadow-md shadow-emerald-900/20 flex items-center gap-1.5 self-start sm:self-center">
              ...
              {PHARMACY_ALERTS.map((med) => (
                <tr key={med.id} className="hover:bg-slate-50 transition-colors">
                  ...
                  <td className="py-3.5 px-4 text-right">
                    <button className="px-3 py-1 text-xs font-bold text-emerald-700 bg-emerald-50 hover:bg-emerald-100 rounded-lg border border-emerald-200">
                      Re-order Stock
                    </button>
                  </td>
                </tr>
