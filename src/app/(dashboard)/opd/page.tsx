...
import { Stethoscope, User, FileText, Plus, CheckCircle } from 'lucide-react';
        ...
        <div className="lg:col-span-2 bg-white p-5 rounded-2xl border border-slate-200 shadow-sm space-y-4">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-end gap-3 pt-2">
              <button className="px-4 py-2 text-xs font-semibold bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-xl">
                Save Clinical Notes
              </button>
